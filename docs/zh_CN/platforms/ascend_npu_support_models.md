...
本节描述 Ascend NPU 上支持的模型，包括大语言模型、多模态语言模型、Embedding 模型、奖励模型和重排序模型。涵盖了主流的 DeepSeek/Qwen/GLM 系列。
欢迎您根据业务需求启用各种模型。
...
| google/gemma-3-4b-it                          | Gemma 3（多模态）           | **<span style="color: green;">√</span>** | **<span style="color: green;">√</span>** |
...
| 	Alibaba-NLP/gme-Qwen2-VL-2B-Instruct     | GME（多模态）              | **<span style="color: green;">√</span>** | **<span style="color: green;">√</span>** |
