...
本节介绍 DeepSeek 和 Qwen 等主流 LLM 模型在 Ascend NPU 上的最佳实践数据。如果您遇到问题或有任何疑问，请[提交 issue](https://github.com/sgl-project/sglang/issues)。

## DeepSeek 系列模型

### 低延迟

| 模型              | 硬件          | 卡数  | 部署模式      | 数据集    | TPOT | 量化方式     | 配置                                                                                  |
|-------------------|---------------|-------|---------------|-----------|------|--------------|---------------------------------------------------------------------------------------|
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离       | 6K+1.6K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-6k-1_6k-20ms-on-a3-32-cards-separation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离       | 3.9K+1K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_9k-1k-20ms-on-a3-32-cards-separation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离       | 3.5K+1.5K | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-20ms-on-a3-32-cards-separation-mode)   |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离       | 3.5K+1K   | 20ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1k-20ms-on-a3-32-cards-separation-mode)     |
| DeepSeek-V3.2-Exp | Atlas 800I A3 | 32    | PD 分离       | 64K+3K    | 30ms | W8A8 INT8    | [最优配置](#deepseek-v32-exp-64k-3k-30ms-on-a3-32-cards-separation-mode) |

### 高吞吐

| 模型        | 硬件          | 卡数  | 部署模式      | 数据集    | TPOT | 量化方式     | 配置                                                                                |
|-------------|---------------|-------|---------------|-----------|------|--------------|-------------------------------------------------------------------------------------|
| Deepseek-R1 | Atlas 800I A3 | 32    | PD 分离       | 3.5K+1.5K | 50ms | W8A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-32-cards-separation-mode) |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD 混合       | 2K+2K     | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-2k-2k-50ms-on-a3-8-cards-mixed-mode)           |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离       | 2K+2K     | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-2k-2k-50ms-on-a3-16-cards-separation-mode)     |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD 混合       | 3.5K+1.5K | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)       |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离       | 3.5K+1.5K | 50ms | W4A8 INT8    | [最优配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-16-cards-separation-mode) |
...
| 模型            | 硬件          | 卡数  | 部署模式    | 数据集  | TPOT | 量化方式     | 配置                                                                           |
|-----------------|---------------|-------|-------------|---------|------|--------------|--------------------------------------------------------------------------------|
| Qwen3-235B-A22B | Atlas 800I A3 | 8     | PD 混合     | 11K+1K  | 10ms | BF16         | [最优配置](#qwen3-235b-a22b-11k-1k-10ms-on-a3-8-cards-mixed-mode) |
| Qwen3-32B       | Atlas 800I A3 | 4     | PD 混合     | 6K+1.5K | 18ms | BF16         | [最优配置](#qwen3-32b-6k-1_5k-18ms-on-a3-4-cards-mixed-mode)      |
| Qwen3-32B       | Atlas 800I A3 | 4     | PD 混合     | 4K+1.5K | 11ms | BF16         | [最优配置](#qwen3-32b-4k-1_5k-11ms-on-a3-4-cards-mixed-mode)      |
| Qwen3-32B       | Atlas 800I A3 | 8     | PD 混合     | 18K+4K  | 12ms | BF16         | [最优配置](#qwen3-32b-18k-4k-12ms-on-a3-8-cards-mixed-mode)       |
| Qwen3-32B       | Atlas 800I A2 | 8     | PD 混合     | 6K+1.5K | 18ms | W8A8 INT8    | [最优配置](#qwen3-32b-6k-1_5k-18ms-on-a2-8-cards-mixed-mode)      |
| Qwen3-32B       | Atlas 800I A2 | 8     | PD 混合     | 4K+1.5K | 11ms | BF16         | [最优配置](#qwen3-32b-4k-1_5k-11ms-on-a2-8-cards-mixed-mode)      |

### 高吞吐

| 模型                           | 硬件          | 卡数  | 部署模式      | 数据集    | TPOT  | 量化方式     | 配置                                                                                           |
|--------------------------------|---------------|-------|---------------|-----------|-------|--------------|--------------------------------------------------------------------------------------------------------|
| Qwen3-235B-A22B                | Atlas 800I A3 | 24    | PD 分离       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-3_5k-1_5k-50ms-on-a3-24-cards-separation-mode)                |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)                      |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD 混合       | 2K+2K     | 100ms | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-2k-2k-100ms-on-a3-8-cards-mixed-mode)                         |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD 混合       | 2K+2K     | 50ms  | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-2k-2k-50ms-on-a3-8-cards-mixed-mode)                          |
| Qwen3-235B-A22B                | Atlas 800I A3 | 16    | PD 混合       | 2K+2K     | 50ms  | W8A8 INT8    | [最优配置](#qwen3-235b-a22b-2k-2k-50ms-on-a3-16-cards-mixed-mode)                         |
| Qwen3-32B                      | Atlas 800I A3 | 2     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-32b-3_5k-1_5k-50ms-on-a3-2-cards-mixed-mode)                            |
| Qwen3-32B                      | Atlas 800I A3 | 2     | PD 混合       | 2K+2K     | 50ms  | W8A8 INT8    | [最优配置](#qwen3-32b-2k-2k-50ms-on-a3-2-cards-mixed-mode)                                |
| Qwen3-30B-A3B                  | Atlas 800I A3 | 1     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-30b-a3b-3_5k-1_5k-50ms-on-a3-1-card-mixed-mode)                         |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 24    | PD 分离       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-24-cards-separation-mode) |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 16    | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-16-cards-mixed-mode)      |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 8     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)       |
| Qwen3-Next-80B-A3B-Instruct    | Atlas 800I A3 | 2     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-next-80B-a3b-instruct-3_5k-1_5k-50ms-on-a3-2-cards-mixed-mode)          |
| Qwen3-32B                      | Atlas 800I A2 | 8     | PD 混合       | 3.5K+1.5K | 50ms  | W8A8 INT8    | [最优配置](#qwen3-32b-3_5k-1_5k-50ms-on-a2-8-cards-mixed-mode)                            |
| Qwen3-32B                      | Atlas 800I A2 | 8     | PD 混合       | 2K+2K     | 50ms  | W8A8 INT8    | [最优配置](#qwen3-32b-2k-2k-50ms-on-a2-8-cards-mixed-mode)                                |

## 最优配置

### DeepSeek-R1 3_5K-1_5K 50ms A3 32 卡分离模式

模型：Deepseek R1

硬件：Atlas 800I A3 32 卡
...
### DeepSeek-R1 6K-1_6K 20ms A3 32 卡分离模式
...
### DeepSeek-R1 3_9K-1K 20ms A3 32 卡分离模式
...
请参考 [DeepSeek-R1 6K-1_6K 20ms A3 32 卡分离模式](#deepseek-r1-6k-1_6k-20ms-on-a3-32-cards-separation-mode)
...
### DeepSeek-R1 3_5K-1_5K 20ms A3 32 卡分离模式
...
### DeepSeek-R1 3_5K-1K 20ms A3 32 卡分离模式
...
### DeepSeek-R1 2K-2K 50ms A3 8 卡混合模式

模型：Deepseek R1

硬件：Atlas 800I A3 8 卡
...
### DeepSeek-R1 2K-2K 50ms A3 16 卡分离模式

模型：Deepseek R1

硬件：Atlas 800I A3 16 卡
...
### DeepSeek-R1 3_5K-1_5K 50ms A3 8 卡混合模式
...
### DeepSeek-R1 3_5K-1_5K 50ms A3 16 卡分离模式
...
### DeepSeek-V3.2-Exp 64K-3K 30ms A3 32 卡分离模式

模型：DeepSeek-V3.2-Exp-W8A8
...
### Qwen3-235B-A22B 3_5K-1_5K 50ms A3 24 卡分离模式

模型：Qwen3-235B-A22B-W8A8

硬件：Atlas 800I A3 24 卡
...
### Qwen3-235B-A22B 3_5K-1_5K 50ms A3 8 卡混合模式
...
### Qwen3-235B-A22B 2K-2K 100ms A3 8 卡混合模式
...
### Qwen3-235B-A22B 2K-2K 50ms A3 8 卡混合模式
...
### Qwen3-235B-A22B 2K-2K 50ms A3 16 卡混合模式
...
### Qwen3-235B-A22B 11K-1K 10ms A3 8 卡混合模式
...
### Qwen3-32B 6K-1_5K 18ms A3 4 卡混合模式

模型：Qwen3-32B

硬件：Atlas 800I A3 4 卡
...
### Qwen3-32B 4K-1_5K 11ms A3 4 卡混合模式
...
### Qwen3-32B 18K-4K 12ms A3 8 卡混合模式
...
### Qwen3-32B 3_5K-1_5K 50ms A3 2 卡混合模式

模型：Qwen3-32B

硬件：Atlas 800I A3 2 卡
...
### Qwen3-32B 2K-2K 50ms A3 2 卡混合模式
...
### Qwen3-30B-A3B 3_5K-1_5K 50ms A3 1 卡混合模式

模型：Qwen3-30B-A3B-Instruct-2507

硬件：Atlas 800I A3 1 卡
...
### Qwen3-Coder-480B-A35B-Instruct 3_5K-1_5K 50ms A3 24 卡分离模式
...
### Qwen3-Coder-480B-A35B-Instruct 3_5K-1_5K 50ms A3 16 卡混合模式
...
### Qwen3-Coder-480B-A35B-Instruct 3_5K-1_5K 50ms A3 8 卡混合模式
...
### Qwen3-Next-80B-A3B-Instruct 3_5K-1_5K 50ms A3 2 卡混合模式
...
### Qwen3-32B 6K-1_5K 18ms A2 8 卡混合模式

模型：Qwen3-32B

硬件：Atlas 800I A2 8 卡
...
### Qwen3-32B 4K-1_5K 11ms A2 8 卡混合模式
...
### Qwen3-32B 3_5K-1_5K 50ms A2 8 卡混合模式
...
### Qwen3-32B 2K-2K 50ms A2 8 卡混合模式
